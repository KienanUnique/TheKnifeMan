...
{
    public class LongRangeEnemyPartsFactory : AEnemyPartsFactory
    {
        public LongRangeEnemyPartsFactory(DiContainer mainContainer) : base(mainContainer)
        {
        }
        ...
        protected override void HandleCreateParts(DiContainer container, object[] extraArgs)
        {
            ...
            container.BindInterfacesTo<LongRangeAttackEnemyVisualPart>().AsSingle().WithArguments(extraArgs);
